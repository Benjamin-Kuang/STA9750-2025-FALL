...
GLOBAL_TOP_10 |>
  ...
  group_by(show_title) |> 
  summarize(`Cumulative Weeks` = cumulative_weeks_in_top_10) |> 
...
GLOBAL_TOP_10 |>
  ...
  group_by(show_title) |>
  summarize(`Runtime (Minutes)` = round(60 * runtime)) |>
...
COUNTRY_TOP_10 |>
  ...
  summarize(`Run Time` = cumulative_weeks_in_top_10) |> 
